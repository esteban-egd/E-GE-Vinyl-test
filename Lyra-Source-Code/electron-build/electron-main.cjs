...
function resolvePreloadPath() {
  const candidates = [
    import_path7.default.join(__dirname, "src", "preload.cjs"),
    import_path7.default.join(__dirname, "src", "preload.js"),
    import_path7.default.join(__dirname, "preload.cjs"),
    import_path7.default.join(__dirname, "preload.js"),
    import_path7.default.join(import_electron20.app.getAppPath(), "electron-build", "src", "preload.cjs"),
